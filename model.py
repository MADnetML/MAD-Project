...
class MADNet(nn.Module):
    def __init__(self, input_shape, look_in=False):
        ...
        assert input_shape[1] >= 180 and input_shape[2] >= 180, 'MADError: n1 or n2 are smaller than 180. Remember: we chose n1=n2=200 and m1=m2=20'
    ...
    def forward(self, x):
        ...
        if self.look_in:
            return active_out, kernel_out, activated_cnn, kerneled_cnn
        else:
            return active_out, kernel_out
...
class MADNet2(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.look_in:
            return active_out, kernel_out, x
        return active_out, kernel_out
